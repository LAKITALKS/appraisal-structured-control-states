...
Result artifacts (metrics, tables, figures, with seeds and the frozen model
revision hash) will appear here only after the pilot is actually run and reviewed.
