...
produce the repository PDF. The v0.1.2 correction is released on GitHub, and the
committed PDF is its official Release artifact; the version-specific Zenodo DOI is
pending and will be recorded after archival. Historical archives remain unchanged:
v0.1.1 is
