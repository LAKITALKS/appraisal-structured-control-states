...
\date{Version 0.1.1 --- Pre-Data Amendment (2026-07-12)}
...
\medskip
\noindent\textbf{v0.1.1 pre-data amendment.} This is the v0.1.1 revision, a
transparent amendment made \emph{before any data collection}. It sharpens one point
in particular: demonstrating several individual task-state directions is not
evidence of a shared control \emph{family}, so v0.1.1 adds an explicit
family-structure test, a fixed primary direction-derivation rule, a concept-mention
stimulus-quality protocol, a two-tier response-strategy taxonomy, a modular
mini-shard protocol, a distinct-replication-model constraint, and expanded verified
prior art. The full amendment is documented in the repository at
\texttt{preregistration/amendment-v0.1.1.md}. No data have been collected.
\end{abstract}
...
content under CC BY 4.0. This version (v0.1.1) is archived on Zenodo at
DOI~\texttt{10.5281/zenodo.21335529} (concept DOI \texttt{10.5281/zenodo.21294932},
resolving to the latest version; the v0.1.0 preregistration remains at
\texttt{10.5281/zenodo.21294933}).
